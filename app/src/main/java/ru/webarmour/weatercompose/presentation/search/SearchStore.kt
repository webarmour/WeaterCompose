...
import ru.webarmour.weatercompose.presentation.search.SearchStore.Intent
import ru.webarmour.weatercompose.presentation.search.SearchStore.Label
import ru.webarmour.weatercompose.presentation.search.SearchStore.State
...
interface SearchStore : Store<Intent, State, Label> {
    ...
    data class State(
        ...
        sealed interface SearchState {
            ...
            data class SuccessLoad(val cities: List<City>) : SearchState
                ...
                is Intent.ClickCity -> {
                    ...
                    when (openReason) {
                        OpenReason.AddToFavourite -> {
                            scope.launch {
                                changeFavouriteStateUseCase.addCityToFavourites(intent.city)
        ...
        override fun State.reduce(msg: Msg): State = when (msg) {
            ...
            is Msg.SearchResultLoaded -> {
                if (msg.cities.isEmpty()) {
                    ...
                    copy(searchState = State.SearchState.SuccessLoad(msg.cities))
                }
            }
        }
    }

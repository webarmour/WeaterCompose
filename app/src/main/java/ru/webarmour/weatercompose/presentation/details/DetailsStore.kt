...
import ru.webarmour.weatercompose.domain.usecase.GetForecastUseCase
import ru.webarmour.weatercompose.domain.usecase.ObserveFavouriteStateUseCase
import ru.webarmour.weatercompose.presentation.details.DetailsStore.Intent
import ru.webarmour.weatercompose.presentation.details.DetailsStore.Label
import ru.webarmour.weatercompose.presentation.details.DetailsStore.State
                ...
                Intent.ClickChangeFavouriteStatus -> {
                    scope.launch {
                        ...
                        if (state.isFavourite) {
                            changeFavouriteStateUseCase.removeCityFromFavourites(state.city.id)
                        } else {
                            changeFavouriteStateUseCase.addCityToFavourites(state.city)
                        }
                    }
                }
            }
